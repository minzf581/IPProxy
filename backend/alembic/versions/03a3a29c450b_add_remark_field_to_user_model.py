"""add remark field to user model

Revision ID: 03a3a29c450b
Revises: 290333ada430
Create Date: 2025-01-27 15:05:56.539148
...
revision: str = '03a3a29c450b'
down_revision: Union[str, None] = '290333ada430'
...
def upgrade() -> None:
    ...
    op.add_column('users', sa.Column('remark', sa.String(length=500), nullable=True))
