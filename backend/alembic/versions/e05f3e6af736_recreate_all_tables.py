...
Revision ID: e05f3e6af736
Revises: 
Create Date: 2025-02-19 13:53:59.226581
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_product_inventory_city_code'), 'product_inventory', ['city_code'], unique=False)
    op.create_index(op.f('ix_product_inventory_country_code'), 'product_inventory', ['country_code'], unique=False)
    op.create_index(op.f('ix_product_inventory_product_no'), 'product_inventory', ['product_no'], unique=True)
    op.create_index(op.f('ix_product_inventory_proxy_type'), 'product_inventory', ['proxy_type'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_product_inventory_proxy_type'), table_name='product_inventory')
    op.drop_index(op.f('ix_product_inventory_product_no'), table_name='product_inventory')
    op.drop_index(op.f('ix_product_inventory_country_code'), table_name='product_inventory')
    op.drop_index(op.f('ix_product_inventory_city_code'), table_name='product_inventory')
