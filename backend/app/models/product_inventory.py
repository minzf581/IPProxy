...
class ProductInventory(Base, TimestampMixin):
    ...
    area_code = Column(String(20), index=True, comment='区域代码')
    country_code = Column(String(3), nullable=False, index=True, comment='国家代码')
    ...
    supplier_code = Column(String(20), index=True, comment='供应商代码')
