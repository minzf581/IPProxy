...
const StaticOrderDetailModal: React.FC<Props> = ({
  visible,
  onCancel,
  orderId,
  onSuccess
  ...
  const [order, setOrder] = useState<StaticOrder | null>(null);
        ...
        {order.status === 'active' && (
          <div style={{ textAlign: 'right' }}>
            <InputNumber
              ...
              step={1}
              value={renewDuration}
              onChange={value => setRenewDuration(value || 30)}
              addonAfter="天"
            />
            <Button
              type="primary"
...
export default StaticOrderDetailModal;
